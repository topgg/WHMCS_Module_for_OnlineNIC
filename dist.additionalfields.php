...
$additionaldomainfields['.com'][] = $additionaldomainfields['.net'][] = [
   "Name" => "IDN Language",
   'DisplayName' => 'IDN Language',
    ...
    "Options" => implode(
        ',',
        [
            '0|select idn language if you need',
            'AFR|Afrikaans',
            'ALB|Albanian',
            'ARA|Arabic',
            'ARG|Aragonese',
...
$additionaldomainfields['.corenic'][] = [
    "Name" => "IDN Language",
    'DisplayName' => 'IDN Language',
    "Type" => "dropdown",
    "Options" => implode(
...
$additionaldomainfields['.neustar'][] = [
    "Name" => "IDN Language",
    'DisplayName' => 'IDN Language',
    "Type" => "dropdown",
    "Options" => implode(
